...
import ftbc7 from '../src/data/28-03-2022_21-10-2022_BATCH7.json';
import ptbc3 from '../src/data/12-03-2022_18-02-2023_BATCH3.json';
import ftbc200 from '../src/data/11-04-2022_04-11-2022_BATCH200.json';
...
function App() {
  ...
  const batchArray = [{name:"ptbc1", content: ptbc1}, {name:"ptbc2", content: ptbc2}, {name:"ptbc3", content: ptbc3}, {name:"ftbc5", content: ftbc5}, {name:"ftbc6", content: ftbc6}, {name:"ftbc7", content: ftbc7}, {name:"ftbc200", content: ftbc200}];
